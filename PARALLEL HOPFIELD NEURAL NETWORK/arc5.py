...
print("\nSTACKED HOPFIELD NUERAL NETWORK PARALLEL CYCLE FUNCTION: ") 
print("\nBY MANU")
...
print("eights : ", Weights)
m1 = int(input("Entern the number of row in Matrix2"))
n1 = int(input("Entern the number of column in Matrix2"))
Weights1 = []
for i in range(0, m):
    Weights1.append([])
for i in range(0, m):
...
p = int(input("Entern the number of row in Matrix3"))
q = int(input("Entern the number of column in Matrix3"))
V = []
for i in range(0, p):
    V.append([])
for i in range(0, p):
    for j in range(0, q):
        ...
        V[i][j] = int(input())
print("v matrix", V)
x = int(input("Entern the number of row in Matrix4"))
y = int(input("Entern the number of column in Matrix4"))
Threshold = []
for i in range(0, x):
    Threshold.append([])
for i in range(0, x):
